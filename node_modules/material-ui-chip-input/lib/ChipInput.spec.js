...
it('does not clear the input on blur with clearOnBlur set to false', function () {
  var tree = (0, _enzyme.mount)(_react2.default.createElement(_ChipInput2.default, { value: ['a', 'b'], clearOnBlur: false }));
  tree.find('input').simulate('change', { target: { value: 'foo' } });
  tree.find('input').simulate('blur');
